...
if ( !function_exists( 'st_get_preset_theme_mod_overrides' ) ) {
	...
	function st_get_preset_theme_mod_overrides( $preset_name ) {
		...
		return array(
			...
			'st_h2_bgcolor_t'       => $maincolor,  //h2の背景色上部
			...
			'st_h2_designsetting'     => 'stripe_design',        //h2デザインの変更hukidasidesign（吹き出しデザイン）linedesign（囲み&左ラインデザイン）underlinedesign（2色アンダーライン）gradient_underlinedesign（グラデーションアンダーライン）centerlinedesign（センターラインに変更）dotdesign（囲みドットデザイン）stripe_design（ストライプデザイン）underdotdesign（下線ドットデザイン）
			...
			'st_h3_designsetting'     => 'gradient_underlinedesign',        //h3デザインの変更hukidasidesign（吹き出しデザイン）linedesign（囲み&左ラインデザイン）underlinedesign（2色アンダーライン）gradient_underlinedesign（グラデーションアンダーライン）centerlinedesign（センターラインに変更）dotdesign（囲みドットデザイン）stripe_design（ストライプデザイン）underdotdesign（下線ドットデザイン）
			...
			'st_h4hukidasi_design'    => 'yes',        //h4デザインをふきだしに変更
