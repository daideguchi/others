...
// for ajax in forms page
	public static function mp_action_add_form() 
	{
		...
		if ( '' === trim( MP_WP_Ajax::$pst_['settings']['recipient']['toemail'] ) || !MailPress::is_email( ( MP_WP_Ajax::$pst_['settings']['recipient']['toemail'] ) ) )
		{
			$x = new WP_Ajax_Response( array( 	'what' => 'form', 
		...
		$form = MP_Form::insert( MP_WP_Ajax::$pst_ );
...
// for ajax in fields page
	public static function mp_action_add_field() 
	{
		...
		$field = MP_Form_field::insert( MP_WP_Ajax::$pst_ );
...
// for preview
	...
	{
		$form = MP_Form::get( MP_WP_Ajax::$get_['id'] );
