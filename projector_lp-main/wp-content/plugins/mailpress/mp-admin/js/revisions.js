...
(function($) {
	...
	revisions.init = function() {
		...
		if ( ! window.adminpage || 'toplevel_page_mailpress_mails' !== window.adminpage ) {
			return;
		}
		...
		state = new revisions.model.FrameState({
			...
			mailId: parseInt( revisions.settings.mailId, 10 )
		}, {
