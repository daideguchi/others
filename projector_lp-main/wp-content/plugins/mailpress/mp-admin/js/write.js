...
//			jQuery('#toemail-toname').css('display', v);
	...
	is_email : function(m) { var _r; var data = { action: "mp_ajax", mp_action: "email", email: m }; jQuery.ajax({ data: data, type: "POST", async: false, url: ajaxurl, success: function(r) { _r = r;} }); return (_r==1); },
