...
class MP_Autoresponder
{
	...
	public static function insert( $term_arr, $wp_error = false ) 
	{
		...
		$term_arr['description']['desc']= sanitize_text_field( $term_arr['description']['desc'] );
...
////  Object  ////
	...
	public static function get_object_terms( $object_id = 0, $args = array() )
	{
		...
		uasort( $_terms, array( 'self', 'sort_autoresponders' ) );
		return $_terms;
	}

	public static function sort_autoresponders( $a, $b ) 
	{
		return strcmp( $a['schedule']['date'], $b['schedule']['date'] );
	}
	...
	public static function get_term_objects( $term_id )
	{
		...
		uasort( $_objects, array( 'self', 'sort_autoresponders' ) );
		return $_objects;
	}
